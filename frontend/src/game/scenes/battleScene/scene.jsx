...
class FightScene extends Phaser.Scene {
    ...
    create(data) {
        ...
        this.scene.manager.scenes.forEach(scene => {
            ...
            const isActive = this.scene.isActive(key);
            const isPaused = this.scene.isPaused(key);
            const isSleeping = this.scene.isSleeping(key);
            const isVisible = this.scene.isVisible(key);
