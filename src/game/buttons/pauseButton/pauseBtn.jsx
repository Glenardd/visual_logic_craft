...
export const pauseBtn = (scene, width, height) =>{
    const returnEvent = () =>{
    ...
    scene.add.container(lineX, lineY).add(new ButtonCreate(scene,0,0, "Menu", 25, 50, 200, 0xe85f5f,0x914c4c, returnEvent, true));
};